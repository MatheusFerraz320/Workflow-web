    ...
    >
      ...
      <div className="border-t border-gray-200 p-3 space-y-1">
        <button
          ...
          className="flex w-full items-center justify-center gap-3 rounded-lg p-2 text-sm text-gray-600 hover:bg-gray-100 hover:text-gray-900"
        >
        ...
        <button
          ...
          className="flex w-full items-center justify-center rounded-lg p-2 text-gray-700 hover:bg-gray-100 hover:text-gray-600"
        >
