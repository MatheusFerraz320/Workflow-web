    ...
    <div className="mx-auto max-w-6xl">
      ...
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 self-start rounded-full bg-brand-600 px-5 py-2.5 text-sm font-medium text-white shadow-sm transition-all hover:bg-brand-700 hover:shadow-md"
        >
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-gray-200 py-20 dark:border-gray-700">
          ...
          <button
            onClick={() => setCreateOpen(true)}
            className="mt-6 flex items-center gap-2 rounded-full bg-brand-600 px-5 py-2.5 text-sm font-medium text-white transition-all hover:bg-brand-700"
          >
            <Plus className="h-4 w-4" />
            Novo Quadro
          </button>
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <button
            onClick={() => setCreateOpen(true)}
            className="flex min-h-[220px] cursor-pointer flex-col items-center justify-center gap-3 rounded-2xl border-2 border-dashed border-gray-200 bg-white transition-all hover:-translate-y-0.5 hover:border-brand-400 hover:bg-brand-50/50 hover:shadow-md dark:border-gray-700 dark:bg-gray-900 dark:hover:border-brand-500 dark:hover:bg-brand-950/30"
          >
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gray-100 transition-colors group-hover:bg-brand-100 dark:bg-gray-800 dark:group-hover:bg-brand-900/40">
